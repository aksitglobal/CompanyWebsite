...
@section('content')
    ...
    <section class="career-hero">
        <div class="container">
            ...
            <p style="font-size: 18px; max-width: 650px; margin: 0 auto; color: #ccc;">Discover exciting opportunities to
                grow and make a direct impact at AKSIT GLOBAL. Whether you're a seasoned expert or a passionate learner, we
                have a place for you.</p>
        </div>
    </section>
